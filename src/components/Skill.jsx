...
export default function Skill() {
    return (
        <div name='skills' className='bg-gray-800'>
            <div className='max-w-[1000px] mx-auto bg-gray-800 text-white pt-40' >
                ...
                <div className=' grid grid-cols-2 sm:grid-cols-4  space-x-3 space-y-3'>
                    <div className='hidden'></div>
                    <div className='flex flex-col items-center shadow-md shadow-gray-900 hover:scale-110 duration-300 p-5'>
